document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function clearFormMessage() {
      const msgEl = contactForm.querySelector('.form-status-message');
      if (msgEl) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      fetch(action, {
        ...
        .catch(function (err) {
          showFormMessage('error', err.message || 'Something went wrong. Please try again later.');
        })
        .finally(function () {
          if (submitBtn) {
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Vivato Jewelry uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '07da15d2-895a-4726-9512-0120d39f5d5c',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '07da15d2-895a-4726-9512-0120d39f5d5c';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '07da15d2-895a-4726-9512-0120d39f5d5c';
